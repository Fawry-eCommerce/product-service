...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionMessage> handleProductNotFoundException(ProductNotFoundException ex) {
        return generateExceptionResponseEntity(ex, HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(CategoryNotFoundException.class)
    public ResponseEntity<ExceptionMessage> handleCategoryNotFoundException(CategoryNotFoundException ex) {
        return generateExceptionResponseEntity(ex, HttpStatus.BAD_REQUEST);
    }
